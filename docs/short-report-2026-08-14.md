...
Quatro semanas dedicadas a **portar a camada de mercado transativo** da tese de
...
- **Montar o IEEE European LV Test Feeder** como caso principal citável; a MVLV75
  é o caso de regressão, que serve para comparar com a tese.
- **Decidir a restrição de estado de carga terminal** com o orientador. Ela é
  nossa, não da referência, e refaz todos os números se for removida.
- Retomar a redação do artigo, agora com resultados próprios para reportar.
